...
//    self.selectedImageColor = [UIColor whiteColor];
    self.segmentEdgeInsets = UIEdgeInsetsMake(4.0f, 4.0f, 0.0f, 4.0f);
    
    // base styles
    self.baseColor = [UIColor colorWithRed:240/255.0 green:240/255.0 blue:240/255.0 alpha:1];
...
- (UIImage *)defaultBackgroundImage {
	...
	// shadows
	UIColor* baseInnerShadow = [UIColor whiteColor];
...
- (UIImage *)selectedBackgroundImage {
	...
	UIColor *segmentStrokeColor = [UIColor whiteColor];
