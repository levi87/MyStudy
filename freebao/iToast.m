...
- (void)show
{
    ...
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, textSize.width + kToastTextPadding,
                                                              textSize.height + kToastTextPadding)];
	...
	button.bounds = CGRectMake(0, 0, textSize.width + kToastButtonPaddding, textSize.height + kToastButtonPaddding);
